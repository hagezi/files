...
This README explains how to install and compile **Unbound 1.25.1** from source on an **ARM64 / AArch64** Debian- or Ubuntu-based system.
...
tar -xvzf unbound-1.25.1.tar.gz
cd unbound-1.25.1/
```

### Comment

This guide is pinned to version `1.25.1`. If a newer release is preferred, replace the version number in both the URL and directory name.
